...
// Lazy load ProformaModal
const ProformaModal = React.lazy(() => import("../../components/Tickets/ProformaModal"));

// Componente de carga para Suspense
const ModalLoadingFallback = () => <div>Cargando modal...</div>;
    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <Suspense fallback={<ModalLoadingFallback />}>
        <ProformaModal
          ...
          handleProformaAction={handleProformaAction}
          handleDownloadProforma={handleDownloadProforma}
        />
      </Suspense>
    </div>
  );
